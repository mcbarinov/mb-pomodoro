...
VISIBLE_ACTIONS: dict[IntervalStatus | None, frozenset[str]] = {
...
def format_title(row: IntervalRow | None, today_completed: int) -> str:
...
class TrayController:
    ...
    def run(self) -> None:
        ...
        self._app.start_timer(POLL_INTERVAL_SEC, self._refresh)
        self._app.run()
    ...
    def _refresh(self) -> None:
        ...
        visible = VISIBLE_ACTIONS[status_key]
